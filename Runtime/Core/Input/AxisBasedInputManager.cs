...
namespace Kandooz.InteractionSystem.Core
{
    internal class AxisBasedInputManager : InputManagerBase
    {
        ...
        private const string XRI_LEFT_THUMB_TOUCH = "XRI_Left_ThumbTouch";
        private const string XRI_LEFT_THUMBREST = "XRI_Left_Thumbrest";
        private const string XRI_LEFT_PRIMARY_TOUCH = "XRI_Left_PrimaryTouch";
        private const string XRI_LEFT_SECONDARY_TOUCH = "XRI_Left_SecondaryTouch";
        ...
        private const string XRI_RIGHT_THUMB_TOUCH = "XRI_Right_ThumbTouch";
        private const string XRI_RIGHT_THUMBREST = "XRI_Right_Thumbrest";
        private const string XRI_RIGHT_PRIMARY_TOUCH = "XRI_Right_PrimaryTouch";
        private const string XRI_RIGHT_SECONDARY_TOUCH = "XRI_Right_SecondaryTouch";


        private void Update()
        {
            var leftThumbPressed = Input.GetButton(XRI_LEFT_THUMB_TOUCH) || Input.GetButton(XRI_LEFT_THUMBREST) ||
                                    Input.GetButton(XRI_LEFT_PRIMARY_TOUCH) || Input.GetButton(XRI_LEFT_SECONDARY_TOUCH);
            ...
            var rightThumbPressed = Input.GetButton(XRI_RIGHT_THUMB_TOUCH) || Input.GetButton(XRI_RIGHT_THUMBREST) ||
                                    Input.GetButton(XRI_RIGHT_PRIMARY_TOUCH) || Input.GetButton(XRI_RIGHT_SECONDARY_TOUCH);
